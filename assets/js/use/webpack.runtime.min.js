    ...
    [941],
    {
            ...
            class CarouselHandlerBase extends i.default {
                ...
                getSwiperSettings() {
                    ...
                    Object.keys(n)
                        ...
                        .forEach((t) => {
                            const r = i[t] ? i[t] : o;
                            (s.breakpoints[n[t].value] = { slidesPerView: +e["slides_to_show_" + t] || r, slidesPerGroup: +e["slides_to_scroll_" + t] || 1 }),
                        ...
                        r ? ((s.effect = e.effect), "fade" === e.effect && (s.fadeEffect = { crossFade: !0 })) : (s.slidesPerGroup = +e.slides_to_scroll || 1),
        ...
        4946: (e, t, r) => {
            ...
            var n = r(6784),
                ...
                l = n(r(5633)),
                u = n(r(9603));
            i.default.frontend = { Document: s.default, tools: { StretchElement: o.default }, handlers: { Base: c.default, StretchedElement: a.default, SwiperBase: l.default, CarouselBase: u.default } };
        },
        7955: (e) => {
            "use strict";
            e.exports = elementorModules.ViewModule.extend({
            ...
            t.default = class Scroll {
                static scrollObserver(e) {
                    ...
                    return new IntersectionObserver(function handleIntersect(r) {
                        ...
                        e.callback({ sensitivity: e.sensitivity, isInViewport: i, scrollPercentage: o, intersectionScrollDirection: s }), (t = n);
                    }, r);
                }
        ...
        1265: (e, t, r) => {
            ...
            var i = n(r(641)),
                ...
                c = n(r(2970)),
                l = n(r(8685));
            t.default = window.elementorModules = { Module: i.default, ViewModule: s.default, ArgsObject: o.default, ForceMethodImplementation: l.default, utils: { Masonry: a.default, Scroll: c.default } };
        },
        6784: (e) => {
            ...
            var n = r(4762),
                ...
                b = (e.exports = function (e, t, r) {
                    "Symbol(" === g(h(t), 0, 7) && (t = "[" + m(h(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
                        r && r.getter && (t = "get " + t),
                        r && r.setter && (t = "set " + t),
                        (!o(e, "name") || (c && e.name !== t)) && (a ? f(e, "name", { value: t, configurable: !0 }) : (e.name = t)),
                    ...
                    NullProtoObject =
                        "undefined" != typeof document
                            ? document.domain && n
                                ...
                                : ((t = l("iframe")), (r = "java" + p + ":"), (t.style.display = "none"), c.appendChild(t), (t.src = String(r)), (e = t.contentWindow.document).open(), e.write(scriptTag("document.F=Object")), e.close(), e.F)
                            : NullProtoObjectViaActiveX(n);
                ...
                ? s
                    ? function defineProperty(e, t, r) {
                        if ((o(e), (t = a(t)), o(r), "function" == typeof e && "prototype" === t && "value" in r && h in r && !r[h])) {
                            var n = u(e, t);
                            n && n[h] && ((e[t] = r.value), (r = { configurable: p in r ? r[p] : n[p], enumerable: d in r ? r[d] : n[d], writable: !1 }));
                        }
                        return l(e, t, r);
                    }
                    : l
        ...
        3617: (e, t, r) => {
            ...
            p(f, w) || defineIteratorPrototypeAccessor(w, y), (!x && p(f, v) && f[v] !== Object) || defineIteratorPrototypeAccessor(v, E), (E.prototype = f), n({ global: !0, constructor: !0, forced: x }, { Iterator: E });
        },
        1975: (e, t, r) => {
            "use strict";
            var n = r(8612),
