!function(e, t) {
    ...
    ElementsKit_Helper.megaMenuAjaxLoad = function(t) {
        ...
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                ...
                n.replaceWith('<span class="elementskit-submenu-indicator ekit-spinner"></span>'),
            ...
            success: function(n) {
                ...
                i.replaceWith(n),
                t.find(".elementskit-submenu-indicator.ekit-spinner").replaceWith(o),
    ...
    ElementsKit_Helper.swiper = function(e, t) {
        ...
        if ("function" != typeof Swiper) {
            return new (0,
            elementorFrontend.utils.swiper)(n,t).then((e => e))
        }
        {
    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                ...
                if ("hover" === o || i === this)
                    !l && s?.url && ElementsKit_Helper.isValidURL(s.url) && window.open(s.url, r);
                else {
                    ...
                    if (n.hasClass("item-opened"))
                        return void (!l && s?.url && ElementsKit_Helper.isValidURL(s.url) && window.open(s.url, r))
                }
            }
            ))
        },
        ...
        Countdown_Timer: function(t) {
            ...
            for (let e in i)
                i.hasOwnProperty(e) && "string" == typeof i[e] && (i[e] = ElementsKit_Helper.escapeHtml(i[e]));
            if (n.length) {
        ...
        Image_Comparison: function(e) {
            var t = e.find(".elementskit-image-comparison")
              , n = t.data();
            for (let e in n)
                n.hasOwnProperty(e) && "string" == typeof n[e] && (n[e] = ElementsKit_Helper.escapeHtml(n[e]));
            ...
            ElementsKit_Helper?.observeElement(n[0], (e => {
                n.easyPieChart({
                    barColor: !0 === o.gradientChart ? function(e) {
                        ...
                        return i.addColorStop(0, o.gradientColor1),
        ...
        Back_To_Top: function(t) {
            const n = t.find(".ekit-btt__button")
              , {offset_top: i, show_after: s, show_scroll: o, style: a, foreground: l, background: r} = t.find(".ekit-btt").data("settings");
        ...
        Video: function(t) {
                    ...
                    callbacks: {
                        elementParse: function(n) {
                            ...
                            if (i && "self" === i.videoTypeName && "popup" === i.videoStyle) {
                                ...
                                t.length && (i.autoplay && (t.prop("autoplay", !0).attr("autoplay"),
                                t[0].play()),
                                i.muted && t.prop("muted", !0).attr("muted"),
                                i.loop && t.prop("loop", !0).attr("loop"))
                            }
                        },
                        open: function() {
            ...
            var a, l = t.find(".ekit-inline-video-content"), r = l.find(".ekit-video-inline-btn");
            l.find(".ekit-inline-video-overlay-image").length > 0 && r.length > 0 && r.on("click", (function(n) {
                if (n.preventDefault(),
                "self" === o.videoTypeName && "inline" === o.videoStyle) {
                    let t = e(".ekit-video-frame video.inline_video_class");
                    t.length && o.autoplay && (t.prop("autoplay", !0).attr("autoplay"),
                    t[0].play())
                    ...
                    if (e.length) {
                        let t = e.attr("src") || "";
                        /[?&]autoplay=1/.test(t) || (/[?&]autoplay=\d/.test(t) ? t = t.replace(/autoplay=\d/, "autoplay=1") : t += (t.indexOf("?") > -1 ? "&" : "?") + "autoplay=1",
                        e.attr("src", t))
                    }
                }
                var i = e(this).closest(".ekit-inline-video-content");
                i.find(".ekit-inline-video-overlay-image, .ekit-video-inline-btn").hide(),
                i.find("iframe, video").show()
            }
            ))
        },
        ...
        return this.each((function() {
            ...
            e({
                ...
                step: function() {
                    ...
                    n && o.text(o.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"))
                },
                complete: function() {
                    parseInt(o.text(), 10) !== t && (o.text(t),
                    n && o.text(o.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")))
                }
            })
        }
