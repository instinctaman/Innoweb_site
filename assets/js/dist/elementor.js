!function(e, t) {
    "use strict";
    "function" != typeof ElementsKit_Helper.swiper && (ElementsKit_Helper.swiper = function(e, t) {
        var i = e.get(0);
        if ("function" != typeof Swiper) {
            return new (0,
            elementorFrontend.utils.swiper)(i,t).then((e => e))
        }
        {
    ...
    let i = {
        ...
        Handle_Review_More: function(t) {
            e(t).find(".more").each((function() {
                e(this).click(( () => {
                    ...
                    !0 === e(this).data("collapsed") ? (e(t).text(e(this).data("text")),
                    e(this).text("...Collapse")) : (e(t).text(e(this).data("text").substr(0, 120)),
                    e(this).text("...More")),
        ...
        Advanced_Toggle: function(t) {
            ...
            t.find(".elemenetskit-toggle-indicator").length > 0) {
                ...
                function l(e, t) {
                    ...
                    s.attr("class", "elemenetskit-toggle-indicator " + t.parents("li").data("elementor_current_item")),
                    s.css({
                        width: i,
                        height: n,
                        left: a,
        ...
        Advanced_Tab: function(n) {
            ...
            a.on("shown.bs.tab", (function() {
                ...
                "yes" == o?.ekit_hash_change && a.click("shown.bs.tab", (function() {
        ...
        MotionText: function(t) {
            ...
            if (i.hasClass("ekit_char_based")) {
                ...
                e.each(a, (function(e, t) {
                    l += " " === t ? t : '<span class="ekit-letter" style="animation-delay: ' + s + "ms; -moz-animation-delay: " + s + "ms; -webkit-animation-delay: " + s + 'ms;">' + t + "</span>",
                    s += o
                }
                )),
                n.html(l)
        ...
        Unfold: function(t) {
            var i = t.find(".ekit-unfold-btn")
              ...
              , o = n.data("config");
            o.collapse_height >= s.outerHeight() ? (i.hide(),
            a.addClass("active")) : (i.show(),
            ...
            i.off("click").on("click", (function() {
                ...
                i.html(ElementsKit_Helper.removeSpecificCharacters(o.expand_text))) : (a.animate({
                    height: s.outerHeight()
                }, parseInt(o.transition_duration, 10) || 0),
                i.html(ElementsKit_Helper.removeSpecificCharacters(o.collapse_text))),
                a.toggleClass("active"),
                a.hasClass("active") || setTimeout(( () => {
                    a[0].scrollIntoView({
                        block: "center"
                    })
                }
        ...
        Table: function(i) {
            ...
            if (t.isEditMode() && (n = t.config.elements.data[i.data("model-cid")].attributes),
            i.find(".ekit_table").length > 0) {
                ...
                var d = a.item_per_page ? a.item_per_page : 10
                  , c = {
                    ...
                    autoFill: !0,
                    pageLength: d,
                    lengthMenu: [[d, 10, 25, 50, 100, -1], [d, "10", "25", "50", "100", "All"]],
        ...
        TimeLine: function(t) {
            ...
            let i = null;
            t.find(".horizantal-timeline > .single-timeline").hasClass("hover") || t.find(".horizantal-timeline > .single-timeline").first().addClass("hover").siblings().removeClass("hover"),
        ...
        Hotspot: function(t) {
            ...
            function s() {
                ...
                let o = function(e) {
                    ...
                    if (void 0 !== i)
                        return t <= i.mobile ? "mobile" : t <= i.tablet ? "tablet" : "desktop"
                }(e(this))
                  , l = e(this).data("directions");
                if (l && (e(this).removeClass((function(e, t) {
                    return (t.match(/ekit_hotspot_follow_line_\w+/g) || []).join(" ")
                }
                )),
                l?.[o] ? e(this).addClass(`${l[o]}`) : e(this).addClass(`${l?.desktop}`)),
                e(this).hasClass("ekit_hotspot_follow_line_top") ? t.css({
                    bottom: a,
                    top: "auto"
                ...
                t.css("left", s)) : e(this).hasClass("ekit_hotspot_follow_line_left") && (t.css("top", -(t.height() / 2 - i.width() / 2)),
                t.css("right", s)),
                t.offset().left < 0)
                    e(window).width() <= 480 && e(this).find(".ekit-location_outer").css({
                    ...
                    if (e(window).width() <= 480 && t.width() > e(window).width())
                        e(this).find(".ekit-location_outer").css({
                            "max-width": e(window).width(),
                            "min-width": e(window).width() - 40
                        }),
            ...
            i.on("click", (function() {
                t.find(".ekit-all-activated").length || e(this).parent().siblings().removeClass("active"),
                e(this).parent().toggleClass("active").removeClass("ekit-all-activated")
            }
            )),
        ...
        Vertical_Menu: function(t) {
            if (t.find(".ekit-vertical-main-menu-on-click").length > 0) {
                ...
                n.on("click", (function(e) {
                    e.preventDefault(),
                    i.toggleClass("vertical-menu-active")
                }
                ))
            }
        ...
        Video_Gallery: function(i) {
            var n = i.find(".video-link.popup")
              ...
              , s = (i.find(".ekit-video-gallery-wrapper.ekit-masonry"),
            ...
            if (i.on("click", ".ekit-blog-post-pagination-container a.page-numbers", (function(t) {
                ...
                e.ajax({
                    ...
                    e(o).imagesLoaded((function() {
                        var t = e(s.items);
                        t.data("masonry") ? (t.masonry("reloadItems"),
                        t.masonry("layout")) : t.masonry({
        ...
        Advanced_Slider: function(i) {
            ...
            var l = {
                ...
                on: {
                    init: function() {
                        c(this),
                        d(this),
                        "yes" === o?.sliderOptions.sliderThumbsShow && function() {
                            ...
                            "horizontal" === t.sliderDirectionType ? (d.width = t.sliderThumbsOffset.size ? `${t.sliderThumbsOffset.size}%` : "70%",
                            d.gridTemplateColumns = `repeat(${r}, 1fr)`,
                            d.gridTemplateRows = "1fr",
                            d.marginTop = "7px") : (d.gridTemplateColumns = "1fr",
                            d.gridTemplateRows = `repeat(${r}, 1fr)`);
                            a.css(d),
                            n.addClass("slider-thumbs-yes")
                        }()
                    },
                    slideChange: function() {
                        var e;
                        e = this,
                        s.removeClass("progress-bar-active"),
                        e.update()
                    },
                    slideChangeTransitionEnd: function() {
                        ...
                        c(this),
                        e = this,
                        s.addClass("progress-bar-active"),
                        e.update()
                    },
            ...
            "horizontal" == o.sliderOptions.sliderDirectionType ? (l.slidesPerView = o.sliderOptions.slidesPerViewItem,
            l.spaceBetween = o.sliderOptions.spaceBetweenGap,
            l.breakpoints = o.sliderOptions.breakpointsOption) : l.slidesPerView = 1,
            "yes" != o.sliderOptions.sliderAutoPlay && "yes" != o.sliderOptions.progressBar || (l.autoplay = {
            ...
            "yes" == o.sliderOptions.progressBar && (i.find(".ekit-slider-wrapper, .ekit-swiper-progress").each((function(t, i) {
        ...
        Whatsapp: function(e) {
            const t = e.find(".elementskit-whatsapp__popup--btn")
              ...
              , p = () => {
                setTimeout(( () => {
                    d.remove(),
                    e.find(".elementskit-whatsapp__chat--title").fadeIn()
                }
                ), 3e3)
            }
              , f = () => {
            ...
            i.keypress((function(e) {
                13 == e.which && (f(),
                "_self" == s ? window.location.assign(a) : "_blank" == s ? window.open(a) : u({
                    url: a,
                    title: "popup",
                    w: 700,
                    h: 600
            ...
            if ("animated" === i.animationStyle) {
                ...
                function f() {
                    ...
                    t.find(".ekit-fancy-text.letters").find("b").each((function() {
                        ...
                        for (let e in i)
                            " " == i[e] && (i[e] = "&nbsp;"),
                            t.parents(".rotate-2").length > 0 && (i[e] = "<em>" + i[e] + "</em>"),
                ...
                function u(e) {
                    ...
                    if (e.parents(".ekit-fancy-text").hasClass("type")) {
                        ...
                        e.parents(".ekit-fancy-text").hasClass("clip") ? e.parents(".ekit-fancy-text-lists").animate({
                            width: "2px"
                        }, c, (function() {
                            v(e, t),
                            h(t)
                        }
                        )) : e.parents(".ekit-fancy-text").hasClass("bar-loading") ? (e.parents(".ekit-fancy-text-lists").removeClass("is-loading"),
                        v(e, t),
                        setTimeout((function() {
                            u(t)
                        }
                ...
                function h(e, t) {
                    e.parents(".ekit-fancy-text").hasClass("type") ? (k(e.find("i").eq(0), e, !1, t),
                    e.addClass("is-visible").removeClass("is-hidden")) : e.parents(".ekit-fancy-text").hasClass("clip") && e.parents(".ekit-fancy-text-lists").animate({
                ...
                function m(t, i, a, s) {
                    if (t.removeClass("in").addClass("out"),
                    t.is(":last-child") ? a && setTimeout((function() {
                        u(g(i))
                    }
                ...
                function k(e, t, i, a) {
                    ...
                    e.is(":last-child") ? (t.parents(".ekit-fancy-text").hasClass("type") && setTimeout((function() {
        ...
        Image_Morphing: function(e) {
            let i, n, a, s = e.find(".ekit-morphing-wrapper").data("paths"), o = e.find(".ekit-morphing-wrapper").find("path")[0], l = e.data("settings");
            ...
            anime(r),
            l.ekit_svg_path_position_scale != undefined && (i = l.ekit_svg_path_position_scale.size ? l.ekit_svg_path_position_scale.size : "1",
            ...
            e.find(".ekit-morphing-wrapper svg.ekit-custom-svg ").find("path").css({
        ...
        Content_Ticker: function(i) {
            ...
            if ("marquee" !== o) {
                ...
                function r(e) {
                    if ("vertical" === s.settingOptions.tickerDirection) {
                        ...
                        n.find(".ekit-marquee .swiper-wrapper, .ekit-marquee-item").css("height", `${i}px`),
                        e.update()
                    }
                }
                function d(t) {
                    if ("typing" === o) {
                        ...
                        let o = 0;
                        !function l() {
                            o < a.length && (n[0].innerHTML += a.charAt(o),
                            o++,
            ...
            if ("marquee" === o) {
                ...
                "yes" !== s.settingOptions.tickerGapBetween && (p.append(u),
        ...
        Interactive_Links: function(t) {
            ...
            i.mouseenter((function() {
                e(this).hasClass("ekit-interactive-active") || (e(this).addClass("ekit-interactive-active").siblings().removeClass("ekit-interactive-active"),
